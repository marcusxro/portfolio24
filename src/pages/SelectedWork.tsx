        ...
        <div className="SelectedWorks slctd" style={{ height: leftColumnRef.current?.scrollHeight + 'px' }}>
            ...
            <div className="content">
                <div className="left" ref={leftColumnRef}>
                    {filteredObj.length > 0 && filteredObj[0]?.images.length > 0 &&
                        filteredObj[0].images.map((image, index) => (
                            image.type === 'img' ?
                ...
                <div className="right" ref={rightColumnRef}>
                    <div className="content">
                        <div className="title">{filteredObj[0]?.title}</div>
                        <div className="innerCon">
                            <div className="info">
                                <div className="headerText">INFO</div>
                                <div className="text">{filteredObj[0]?.info}</div>
                            </div>
                            <div className="role">
                                <div className="headerText">ROLES</div>
                                {filteredObj[0]?.role.map((itm, index) => (
                                    <div className="roles" key={index}>{itm}</div>
                                ))}
                            </div>
                            <div className="tech">
                                <div className="headerText">TECHNOLOGIES</div>
                                {filteredObj[0]?.techs.map((itm, index) => (
                                    <div className="roles" key={index}>{itm}</div>
                                ))}
                            </div>
                        </div>
